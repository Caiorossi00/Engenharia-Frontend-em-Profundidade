...
1. React será estudado como um sistema, não como uma coleção de APIs.
...
2. Os conceitos se acumulam camada por camada.

A leitura dos módulos foi estruturada para criar um efeito cumulativo:

- a filosofia do React prepara o terreno para entender seu motor;
- o motor fundamenta os hooks;
- os hooks fundamentam o estado;
- o estado fundamenta a arquitetura e a performance;
- todos convergem no entendimento do React moderno.

O leitor deve avançar esperando que cada módulo se apoie no anterior.

3. A assimilação será mais valiosa que a velocidade.
